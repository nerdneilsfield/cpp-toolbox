...
measure. There are several ways to use results that will prevent the optimizer
...
code are guaranteed to be evaluated and not optimized out. This means that if
