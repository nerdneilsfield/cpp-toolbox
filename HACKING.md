...
hidden if the `cpp-toolbox-new_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cpp-toolbox-new_DEVELOPER_MODE` to the configure
